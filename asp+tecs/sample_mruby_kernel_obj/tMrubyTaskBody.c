 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: tMrubyTaskBody.c 283 2009-05-08 06:52:59Z ertl-takuya $
 */
...
#include "tMrubyTaskBody_tecsgen.h"
#include <kernel.h>
#include <t_syslog.h>
#include <t_stdlib.h>
#include "kernel_cfg.h"
#include "tMrubyTaskBody.h"
 ...
 *  メインタスク
 */
/* 属性の設定 *//* #[<ENTRY_FUNC>]# eMrubyTask_main
 * name:         eMrubyTask_main
 * global_name:  tMrubyTaskBody_eMrubyTask_main
 * oneway:       
 * #[/ENTRY_FUNC>]# */
void
eMrubyTask_main()
