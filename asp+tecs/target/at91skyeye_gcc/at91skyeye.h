 ...
 *  Copyright (C) 2010 by Ubiquitous Computing and Networking Laboratory
 ...
 *  UART関連
 */
#define USART0_BASE      (0xFFFD0000)  // USART0 base address
#define USART_THR        (0x1C)  // USART Transmitter Holding Register
#define USART_RPR        (0x30)  // USART Receive Pointer Register
#define USART_RCR        (0x34)  // USART Receive Counter Register
#define USART_CSR        (0x14)  // USART Channel Satus Register
#define USART_IER        (0x08)  // USART Interrupt Enable Register
#define USART_IDR        (0x0C)  // USART Interrupt Disable Register
