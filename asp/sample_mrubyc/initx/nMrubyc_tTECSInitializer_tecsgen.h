 ...
 */
#ifndef nMrubyc_tTECSInitializer_TECSGEN_H
#define nMrubyc_tTECSInitializer_TECSGEN_H

/*
 * celltype          :  tTECSInitializer
 * global name       :  nMrubyc_tTECSInitializer
...
void         nMruby_tTECSInitializer_eInitialize_initializeBridge(nMruby_tTECSInitializer_IDX idx, const mrb_vm* mrb);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nMruby_tTECSInitializer_N_CELL        (2)  /* セルの個数  #_NCEL_# */
...
#endif /* nMrubyc_tTECSInitializer_TECSGENH */
