 ...
 */
#ifndef nMrubyc_tCharPointer_TECSGEN_H
#define nMrubyc_tCharPointer_TECSGEN_H

/*
 * celltype          :  tCharPointer
 * global name       :  nMrubyc_tCharPointer
...
void         nMruby_tCharPointer_eInitialize_initializeBridge( mrb_vm *vm, struct RClass * TECS);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
/* eInitialize */
void           nMruby_tCharPointer_eInitialize_initializeBridge_skel( const struct tag_nMruby_sInitializeTECSBridge_VDES *epd, mrb_vm* mrb, struct RClass * TECS);
