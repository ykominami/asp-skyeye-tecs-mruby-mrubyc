 ...
 */
#ifndef nMrubyc_tsKernel_Initializer_TECSGEN_H
#define nMrubyc_tsKernel_Initializer_TECSGEN_H

/*
 * celltype          :  tsKernel_Initializer
 * global name       :  nMrubyc_tsKernel_Initializer
...
void         nMruby_tsKernel_Initializer_eInitialize_initializeBridge(nMruby_tsKernel_Initializer_IDX idx, mrb_vm* mrb, struct RClass * TECS);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nMruby_tsKernel_Initializer_N_CELL        (2)  /* セルの個数  #_NCEL_# */
...
#endif /* nMrubyc_tsKernel_Initializer_TECSGENH */
