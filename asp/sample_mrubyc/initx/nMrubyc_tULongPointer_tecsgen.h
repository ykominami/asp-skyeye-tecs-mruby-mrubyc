 ...
 */
#ifndef nMrubyc_tULongPointer_TECSGEN_H
#define nMrubyc_tULongPointer_TECSGEN_H

/*
 * celltype          :  tULongPointer
 * global name       :  nMrubyc_tULongPointer
...
void         nMruby_tULongPointer_eInitialize_initializeBridge( mrb_vm* mrb, struct RClass * TECS);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
/* eInitialize */
void           nMruby_tULongPointer_eInitialize_initializeBridge_skel( const struct tag_nMruby_sInitializeTECSBridge_VDES *epd, mrb_vm* mrb, struct RClass * TECS);
...
#endif /* nMrubyc_tULongPointer_TECSGENH */
